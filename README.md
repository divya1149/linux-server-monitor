...
This project is a Bash-based Linux server monitoring and automation system designed to monitor essential system resources and server health. It collects CPU, memory, disk, and network metrics, classifies the system status, records logs and alerts, generates server reports, and creates compressed backups. The project also uses Cron jobs to automate monitoring and maintenance tasks.
...
* Backup Automation: Creates compressed `.tar.gz` backups of the project files.
...
* Classifies the server condition into Healthy, Warning, or Critical states.
